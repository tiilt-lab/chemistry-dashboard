...
class ProcessingConfig:
    def __init__(self, auth_key, session_key, server_start, start_offset, sample_rate, encoding, channels, transcribe, keywords, doa, features, tag, diarization, embeddingsFile,sessionId,deviceId):
    ...
    def from_json(data):
        ...
        return True, ProcessingConfig(auth_key, session_key, server_start, start_offset, sample_rate, encoding, channels, transcribe, keywords, doa, features, tag, diarization, embeddingsFile,sessionId,deviceId)
