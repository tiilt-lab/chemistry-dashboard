          ...
          style = {{width: adjDim(343) + 'px',}}>
                <thead>
                  <tr>
                    ...
                    style = {{width: adjDim(186) + 'px',}}>Classifier</th>
                    <th className={style["score-header"]}
                    style = {{width: adjDim(59) + 'px', "padding-right": adjDim(24) + 'px',}}>Score</th>
                    <th className={style["graph-header"]}
                ...
                <tbody>
                    {props.features.map((feature, index)=>(
                        <tr key={index}>
                            ...
                            style = {{width: adjDim(59) + 'px', "padding-right": adjDim(24) + 'px',}}>
                              <div className={style.number}
                              style = {{"font-size": adjDim(22) + 'px',}}>{Math.round(feature.average)} </div>
                            ...
                            <td>
                              {feature.values.length == 0 ? <span className={style["no-data-span"]} style={{width: adjDim(74) + "px",}}></span> : <></> }
