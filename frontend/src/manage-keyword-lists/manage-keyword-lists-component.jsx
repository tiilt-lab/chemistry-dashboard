...
function ManageKeywordListsComponent(props) {
  ...
  // Topic-model creation lives on the Topic models tab — the "Create Topic
  // Model" button (and its dead tempFunction twin) that used to route from
  // here into the upload flow was feature bleed between the two areas.
