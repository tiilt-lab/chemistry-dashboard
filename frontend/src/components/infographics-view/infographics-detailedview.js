...
const transcripts1 = selectedSpkrId1 === -1
  ? props.displayTranscripts || []
  : (props.displayTranscripts || []).filter(t => t.speaker_id === selectedSpkrId1);

const transcripts2 = selectedSpkrId2 === -1
  ? props.displayTranscripts || []
  : (props.displayTranscripts || []).filter(t => t.speaker_id === selectedSpkrId2);
