...
export const dlgPrimary =
    "border border-transparent mt-2 h-11 rounded-lg bg-tiilt font-semibold text-white transition hover:bg-tiilt-deep active:translate-y-px"
...
export const dlgDanger =
    "border border-transparent mt-2 h-11 rounded-lg bg-tiilt-danger font-semibold text-white transition hover:brightness-90 active:translate-y-px"
...
export const btnPrimary =
    "border border-transparent rounded-lg bg-tiilt px-4 py-2 text-sm font-semibold text-white transition hover:bg-tiilt-deep active:translate-y-px"
export const btnPrimarySm =
    "border border-transparent rounded-lg bg-tiilt px-3 py-1.5 text-xs font-semibold text-white transition hover:bg-tiilt-deep active:translate-y-px"
export const btnPrimaryTall =
    "border border-transparent flex h-12 items-center justify-center rounded-lg bg-tiilt text-base font-semibold text-white transition hover:bg-tiilt-deep active:translate-y-px"
...
export const btnDanger =
    "border border-transparent rounded-lg bg-tiilt-danger px-4 py-2 text-sm font-semibold text-white transition hover:brightness-90 active:translate-y-px"
