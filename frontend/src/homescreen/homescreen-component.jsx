...
function HomeScreen(props) {
  ...
  return (
    <div className="main-container items-center overflow-y-auto">
      ...
      <Menus menuIcon={ragicon} menuName="User Study" route={navigate} path='/app' />
      <Menus menuIcon={ragicon} menuName="Agent Chat (V7)" route={navigate} path='/chat-v7' />
      <Menus menuIcon={ragicon} menuName="Agent Baseline" route={navigate} path='/chat-baseline' />
      <Menus menuIcon={ragicon} menuName="Rate Agent Responses" route={navigate} path='/expert-agent-rating' />
