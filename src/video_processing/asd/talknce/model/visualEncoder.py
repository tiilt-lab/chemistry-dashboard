...
class visualFrontend(nn.Module):
    """
    A visual feature extraction module. Generates a 512-dim (or 256) feature vector per video frame.
...
class DSConv1d(nn.Module):
    ...
    def __init__(self, emb_dim=512):
        ...
        self.net = nn.Sequential(
            ...
            nn.Conv1d(emb_dim, emb_dim, 3, stride=1, padding=1, dilation=1, groups=emb_dim, bias=False),
            nn.PReLU(),
            GlobalLayerNorm(emb_dim),
