...
from torch.utils.data.dataset import Dataset as Dataset2

from yolo_head.utils.general import xyxy2xywh, xywh2xyxy, xywhn2xyxy, xyn2xy, segment2box, segments2boxes, resample_segments, \
    clean_str
from yolo_head.utils.torch_utils import torch_distributed_zero_first
...
class LoadImageDataset(Dataset2):
    def __init__(self, images,batch, batch_size, img_size=640, stride=32):
        self.img_size = img_size
        self.stride = stride
        self.images = images
